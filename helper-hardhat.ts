...
export const BLOCK_CONFIRMATIONS_FOR_VERIFICATION: number = CHAINS["local"].includes(network.name)
    ? 1
    : 6;
...
export const MOCKS = {
    chainlink: {
        decimalsEthUsd: "8",
        initialPriceFeedValueEthUsd: "3000000000000000000000",
        pointOneLinkFee: "100000000000000000",
        linkPerGas: 1e9, // 0.000000001
    },
};
